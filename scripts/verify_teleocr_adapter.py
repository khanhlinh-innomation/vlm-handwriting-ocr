#!/usr/bin/env python3
"""Reload a saved TeleOCR LoRA adapter and verify one validation inference."""
...
def main() -> None:
    ...
    write_csv(output_dir / "adapter_reload_prediction.csv", [result], list(result))
    write_json(
